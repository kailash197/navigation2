...
protected:
  /**
   * @brief Transforms global plan into the same frame as pose, clips far away
   * poses, and possibly prunes passed poses
   ...
   */
  bool
  shouldRotateToGoalHeading(const geometry_msgs::msg::PoseStamped &carrot_pose);
